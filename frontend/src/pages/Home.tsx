            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <img
                                src="https://img.freepik.com/free-photo/shallow-focus-shot-three-african-males-holding-sticks_181624-46377.jpg?uid=R92480475&ga=GA1.1.427251594.1742837316&w=740"
