...
// Handle login logic here
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <header className="bg-white shadow-md fixed w-full z-50">
                <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        <a href="#about" className="text-gray-700 hover:text-[#00ff00] transition duration-300">About</a>
                        <a href="#features" className="text-gray-700 hover:text-[#00ff00] transition duration-300">Features</a>
                        <a href="#benefits" className="text-gray-700 hover:text-[#00ff00] transition duration-300">Benefits</a>
                        <a href="#contact" className="text-gray-700 hover:text-[#00ff00] transition duration-300">Contact</a>
                    </nav>
                    <div className="hidden md:flex items-center space-x-4">
                                    ...
                                    <form id="loginForm" onSubmit={handleLoginSubmit} className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => setLoginForm(prev => ({...prev, identifier: 'demo@m-chama.co.ke'}))}
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => setLoginForm(prev => ({...prev, password: 'demo123'}))}
                                                    className="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-[#00ff00] hover:text-[#00dd00]"
                                                >
                                                    Fill Demo
                                                </button>
                        ...
                        <a href="https://readdy.ai/home/4140dace-ee34-45a9-a47b-1a6de15bc824/6a48bc45-3841-4426-a343-1d3222bcaa14" data-readdy="true">
                ...
                <div className={`md:hidden bg-white ${isMenuOpen ? 'block' : 'hidden'}`}>
                    <div className="px-4 py-3 space-y-3">
                        <a href="#about" className="block text-gray-700 hover:text-[#00ff00] transition duration-300">About</a>
                        <a href="#features" className="block text-gray-700 hover:text-[#00ff00] transition duration-300">Features</a>
                        <a href="#benefits" className="block text-gray-700 hover:text-[#00ff00] transition duration-300">Benefits</a>
                        <a href="#contact" className="block text-gray-700 hover:text-[#00ff00] transition duration-300">Contact</a>
            ...
            {/* Hero Section */}
            <section className="pt-24 md:pt-0 relative overflow-hidden" style={{
                ...
                <div className="container mx-auto px-4 h-full flex items-center">
                    <div className="max-w-2xl text-white relative z-10">
                        <h1 className="text-4xl md:text-6xl font-bold mb-4">Welcome to M-Chama</h1>
                        <h2 className="text-xl md:text-2xl mb-6">Digital Group Savings Powered by M-PESA</h2>
                        <p className="text-lg mb-8">Revolutionizing how Chamas operate in Kenya with automated savings, contributions, and loan disbursements - all through the convenience of M-PESA.</p>
            ...
            <section id="about" className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <h3 className="text-2xl font-semibold mb-4">Transforming Traditional Chamas into Digital Powerhouses</h3>
                            <p className="text-gray-700 mb-6">
                                M-Chama is a revolutionary digital platform that modernizes the traditional Chama system in Kenya.
                                By leveraging the power of M-PESA and Safaricom's technology, we're empowering SMEs and SACCOs
                                to manage their group savings and loans with unprecedented efficiency and transparency.
                            </p>
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-700 max-w-2xl mx-auto">
                            Our platform simplifies every aspect of running a Chama, from member management to financial transactions,
                            all integrated seamlessly with M-PESA.
                        </p>
                    </div>
                    <div className="grid md:grid-cols-4 gap-6">
                        <div className="bg-white p-6 rounded-lg shadow-md text-center">
                            ...
                            <p className="text-gray-700">
                                Create your Chama in minutes with a simple registration process. Add members and set contribution rules.
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md text-center">
                            <div className="w-16 h-16 bg-[#e6ffe6] rounded-full flex items-center justify-center mx-auto mb-4">
                            ...
                            <p className="text-gray-700">
                                Easily add, remove, and manage members. Track contributions and participation history.
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md text-center">
                            <div className="w-16 h-16 bg-[#e6ffe6] rounded-full flex items-center justify-center mx-auto mb-4">
                            ...
                            <p className="text-gray-700">
                                Seamless connection with M-PESA for automatic contributions, disbursements, and loan repayments.
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md text-center">
                            <div className="w-16 h-16 bg-[#e6ffe6] rounded-full flex items-center justify-center mx-auto mb-4">
                            ...
                            <h3 className="text-xl font-semibold mb-3">Automated Savings & Loans</h3>
                            <p className="text-gray-700">
                                Set up recurring contributions, manage group funds, and process loan applications digitally.
                            </p>
                        </div>
                    </div>
                    <div className="mt-12 text-center">
                        <div className="relative">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row justify-between">
                                <div className="w-12 h-12 bg-[#00ff00] rounded-full flex items-center justify-center mx-auto mb-4 text-white">1</div>
                                <div className="w-12 h-12 bg-[#00ff00] rounded-full flex items-center justify-center mx-auto mb-4 text-white">2</div>
                                <div className="w-12 h-12 bg-[#00ff00] rounded-full flex items-center justify-center mx-auto mb-4 text-white">3</div>
                                <div className="w-12 h-12 bg-[#00ff00] rounded-full flex items-center justify-center mx-auto mb-4 text-white">4</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="features" className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <div className="w-20 h-1 bg-[#00ff00] mx-auto mb-6"></div>
                        <p className="text-gray-700 max-w-2xl mx-auto">
                            M-Chama combines powerful features with ease of use to create the ultimate digital Chama experience.
                        </p>
                    </div>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="bg-gray-50 p-6 rounded-lg border-t-4 border-[#00ff00]">
                            ...
                            <h3 className="text-xl font-semibold mb-3">Automated M-PESA Contributions</h3>
                            <p className="text-gray-700">
                                Schedule regular contributions with automated reminders and M-PESA payment requests.
                            </p>
                        </div>
                        <div className="bg-gray-50 p-6 rounded-lg border-t-4 border-[#00ff00]">
                            <div className="text-[#00ff00] mb-4">
                            ...
                            <h3 className="text-xl font-semibold mb-3">Smart Reminder System</h3>
                            <p className="text-gray-700">
                                Customizable notifications ensure members never miss a contribution deadline.
                            </p>
                        </div>
                        <div className="bg-gray-50 p-6 rounded-lg border-t-4 border-[#00ff00]">
                            <div className="text-[#00ff00] mb-4">
                            ...
                            <h3 className="text-xl font-semibold mb-3">Digital Record Keeping</h3>
                            <p className="text-gray-700">
                                Comprehensive digital records of all transactions, meetings, and member activities.
                            </p>
                        </div>
                        <div className="bg-gray-50 p-6 rounded-lg border-t-4 border-[#00ff00]">
                            <div className="text-[#00ff00] mb-4">
                            ...
                            <h3 className="text-xl font-semibold mb-3">Transparent Loan Management</h3>
                            <p className="text-gray-700">
                                Streamlined loan application, approval, disbursement, and repayment tracking.
                            </p>
                        </div>
                        <div className="bg-gray-50 p-6 rounded-lg border-t-4 border-[#00ff00]">
                            <div className="text-[#00ff00] mb-4">
                            ...
                            <p className="text-gray-700">
                                Bank-grade security protocols protect all your group's financial data and transactions.
                            </p>
                        </div>
                        <div className="bg-gray-50 p-6 rounded-lg border-t-4 border-[#00ff00]">
                            <div className="text-[#00ff00] mb-4">
                            ...
                            <p className="text-gray-700">
                                Gain insights into your group's financial health with detailed reports and analytics.
                            </p>
                        </div>
                        <div className="bg-gray-50 p-6 rounded-lg border-t-4 border-[#00ff00]">
                            <div className="text-[#00ff00] mb-4">
                            ...
                            <p className="text-gray-700">
                                Built-in voting and decision-making tools for transparent group governance.
                            </p>
                        </div>
                        <div className="bg-gray-50 p-6 rounded-lg border-t-4 border-[#00ff00]">
                            <div className="text-[#00ff00] mb-4">
                            ...
                            <p className="text-gray-700">
                                Schedule, notify, and record minutes for physical or virtual Chama meetings.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section id="benefits" className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <div className="w-20 h-1 bg-[#00ff00] mx-auto mb-6"></div>
                        <p className="text-gray-700 max-w-2xl mx-auto">
                            M-Chama delivers unique advantages for everyone involved in the Chama ecosystem.
                        </p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white p-8 rounded-lg shadow-md">
                            ...
                            <h3 className="text-xl font-semibold mb-4">For Group Administrators</h3>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <div className="w-20 h-1 bg-[#00ff00] mx-auto mb-6"></div>
                        <p className="text-gray-700 max-w-2xl mx-auto">
                            Join M-Chama in three simple steps and transform how your group saves and grows together.
                        </p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold mb-3">1. Download the App</h3>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold mb-3">2. Register Account</h3>
                            <p className="text-gray-700 mb-4">
                                Create your personal account using your M-PESA registered phone number.
                            </p>
                        </div>
                        <div className="text-center">
                            <div className="w-20 h-20 bg-[#e6ffe6] rounded-full flex items-center justify-center mx-auto mb-6">
                            ...
                            <h3 className="text-xl font-semibold mb-3">3. Create/Join Group</h3>
                            <p className="text-gray-700 mb-4">
                                Start your own Chama or join an existing one with an invitation code.
                            </p>
                        </div>
                    </div>
                    <div className="mt-12 text-center">
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <div className="w-20 h-1 bg-[#00ff00] mx-auto mb-6"></div>
                        <p className="text-gray-700 max-w-2xl mx-auto">
                            Your security is our priority. M-Chama leverages Safaricom's trusted infrastructure and advanced security protocols.
                        </p>
                    </div>
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-700">
                                            We implement the same security standards used by leading financial institutions to protect your data and transactions.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-700">
                                            Direct integration with M-PESA ensures all financial transactions are secure, traceable, and protected.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold mb-2">Safaricom Backing</h3>
                                        <p className="text-gray-700">
                                            As a Safaricom-powered solution, M-Chama benefits from the infrastructure and expertise of Kenya's leading telecommunications provider.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-700">
                                            Your personal and financial information is encrypted and protected in compliance with Kenya's data protection regulations.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-xl overflow-hidden">
                        <div className="md:flex">
                            <div className="md:w-1/2 p-8 md:p-12">
                                <h2 className="text-3xl font-bold mb-4">Ready to Transform Your Chama?</h2>
                                <p className="text-gray-700 mb-6">
                                    Join thousands of Chamas across Kenya who are already experiencing the benefits of digital transformation with M-Chama.
                                </p>
                                ...
                                <div className="mt-6 text-center text-gray-600">
                                    ...
                                    <div className="mt-2 flex justify-center space-x-4">
                                        <a href="#" className="text-[#00ff00] hover:text-[#00dd00] cursor-pointer">
                            ...
                            <div className="md:w-1/2 relative">
                                ...
                                <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
                                    <div className="text-center text-white p-6">
                                        ...
                                        <p className="mb-4">Over 10,000 Chamas already trust M-Chama</p>
                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        <div>
                            ...
                            <p className="text-gray-400 mb-4">
                                Revolutionizing group savings and loans in Kenya through digital innovation.
                            </p>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href="#about" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">About Us</a></li>
                                <li><a href="#features" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Features</a></li>
                                <li><a href="#benefits" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Benefits</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">FAQ</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Blog</a></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold mb-4">Support</h3>
                            <ul className="space-y-2">
                                <li><a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Help Center</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Contact Us</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Privacy Policy</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Terms of Service</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Security</a></li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li className="flex items-start">
                                    ...
                                    <span className="text-gray-400">Safaricom House, Waiyaki Way, Nairobi, Kenya</span>
                                </li>
                                <li className="flex items-start">
